...
TextureAtlasKDTree::node* TextureAtlasKDTree::node::insert(unsigned tex, const glm::ivec2& size) {
...
TextureAtlasKDTree::~TextureAtlasKDTree() {
	delete root;
}

glm::ivec2 TextureAtlasKDTree::getSize() {
	if(root != nullptr) {
...
glm::ivec4 TextureAtlasKDTree::insert(unsigned texId, glm::ivec2 size) {
